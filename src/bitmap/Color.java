...
public class Color implements Cloneable {
    ...
    public final float zeroCeiling(float value)
    {
        if(value < 0) return 0;
        else return value;
    }
    ...
    public final Color clamp()
    {
        ...
        c.r = ColorUtility.clamp(r, 0, 1);
        c.g = ColorUtility.clamp(g, 0, 1);
        c.b = ColorUtility.clamp(b, 0, 1);
    ...
    public final byte[] toByteBgraPre()
    {
        ...
        ir = ColorUtility.clamp(ir, 0, 255);
        ig = ColorUtility.clamp(ig, 0, 255);
        ib = ColorUtility.clamp(ib, 0, 255);
        ia = ColorUtility.clamp(ia, 0, 255);
    ...
    public final int toRGBE() {
        ...
        // technique
        float v = ColorUtility.max(r, g, b);
        if (v < 1e-32f)
            return 0;
    ...
    public static int toInt8(float a, float b, float c, float d)
    {
        ...
        ia = ColorUtility.clamp(ia, 0, 255);
        ib = ColorUtility.clamp(ib, 0, 255);
        ic = ColorUtility.clamp(ic, 0, 255);
        id = ColorUtility.clamp(id, 0, 255);
